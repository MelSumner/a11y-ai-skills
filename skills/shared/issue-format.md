...
3. **How to fix**:
  a. Select the safest approved remediation pattern from the remediation library. If no approved pattern applies, do not invent a fix. Mark the finding as `needs_expert_review`.
  b. Always recommend an HDS component first.
